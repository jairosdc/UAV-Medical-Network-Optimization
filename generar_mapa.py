...
def generar_mapa():
    ...
    # 3. Colores vibrantes para los hospitales
    colores_hospitales = [
    ...
    colores_bases = {
        "BASE NOROESTE": "#00FF88",
        "BASE NORTE CAPITAL": "#00CFFF",
        "BASE ESTE CORREDOR": "#FFD700",
        "BASE SUR FUENLABRADA": "#FF9F00"
    }
    
    radios_bases = {
        "BASE NOROESTE": 4000.0,
        "BASE NORTE CAPITAL": 5000.0,
        "BASE ESTE CORREDOR": 4500.0,
        "BASE SUR FUENLABRADA": 4000.0
    }
    ...
    for i, (key, node) in enumerate(HOSPITALS.items()):
        ...
        folium.Marker(
            location=[node.lat + 0.003, node.lon],
            icon=folium.DivIcon(
    ...
    for key, node in BASES.items():
        ...
        radio_cobertura = radios_bases.get(key, 4000.0)
    ...
    <div style="position:fixed;bottom:30px;left:30px;z-index:1000;
      ...
      <b style="color:#FFD700;font-size:14px;">🗺️ Red de Hospitales y Bases</b>
      ...
      <span style="color:#00FF88;">🚁</span> BASE NOROESTE<br>
      <span style="color:#00CFFF;">🚁</span> BASE NORTE CAPITAL<br>
      <span style="color:#FFD700;">🚁</span> BASE ESTE CORREDOR<br>
      <span style="color:#FF9F00;">🚁</span> BASE SUR FUENLABRADA<br>
      <hr style="border-color:#333;margin:8px 0;">
    ...
    output_path = os.path.join(output_dir, "grafo.html")
    m.save(output_path)
